...
class SetupAppium
  ...
  app_file_android = Dir.glob 'app-release.apk'
  ...
  def get_android_driver
    ...
    desired_caps['appPackage'] = 'com.nobigdeal'
    desired_caps['appActivity'] = 'com.nobigdeal.MainActivity'
    desired_caps['deviceName'] = 'Android device'
    #desired_caps['deviceName'] = 'Samsung Galaxy S7 edge'
    #desired_caps['app'] = "https://cloud.bitbar.com/cloud/api/v2/me/files/134123077/file"
    desired_caps['app'] = "/Users/ragnarok/Documents/nbd/apk/app-release.apk"
